Feature: Best Buy Application
  ...
  Scenario Outline: Store Api CRUD Test
    ...
    Examples:
      ...
      | Jhon | WareHouse | 1 London Road | shopping lane | London | Greater London | LL11LL  | 45  | 90  | Mon8to8 |
      | Wick | Store     | 1 Trent Road  | shopping lane | Trent  | Stoke          | SK1 1SK | 90  | 45  | Mon8to8 |
